...
export default function AdvancedPortfolio(): JSX.Element {
        ...
        >
          <motion.div variants={itemVariants} className="max-w-4xl order-2 lg:order-1">
            ...
            <motion.div 
              ...
              variants={itemVariants}
            >
              <a href="tel:+918146823796" className="flex items-center gap-2 sm:gap-3 text-gray-700 dark:text-gray-300 hover:text-cyan-600 transition-colors duration-300 text-sm sm:text-base">
                <Phone size={16} className="sm:w-5 sm:h-5" /> +91 8146823796
              </a>
              <a href="mailto:prathamgupta4174@gmail.com" className="flex items-center gap-2 sm:gap-3 text-gray-700 dark:text-gray-300 hover:text-cyan-600 transition-colors duration-300 text-sm sm:text-base">
                <Mail size={16} className="sm:w-5 sm:h-5" /> prathamgupta4174@gmail.com
              </a>
              <a href="https://linkedin.com/in/pratham-gupta-b90b9b1a0" className="flex items-center gap-2 sm:gap-3 text-gray-700 dark:text-gray-300 hover:text-cyan-600 transition-colors duration-300 text-sm sm:text-base">
  ...
  <div>
    ...
    <div className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm">prathamgupta4174@gmail.com</div>
  </div>
</div>
<div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-blue-50 dark:bg-blue-900/20">
  ...
  <div>
    ...
    <div className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm">+91 8146823796</div>
  </div>
</div>
